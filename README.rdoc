= Authlogic Fork for Mongoid

This is a fork of authlogic to make it work with mongoid. To use, add this line to your Gemfile:

  gem 'mongoid-authlogic', git: 'git@github.com:janx/authlogic.git', require: 'authlogic'

and this in your user model before any authlogic stuff (e.g. `acts_as_authentic`):
