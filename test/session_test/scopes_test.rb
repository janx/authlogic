...
module SessionTest
  class ScopesTest < ActiveSupport::TestCase
    ...
    def test_with_scope_method
      ...
      UserSession.with_scope(:find_options => {awesome: 1}, :id => "some_id") do
        assert_equal({:find_options => {awesome: 1}, :id => "some_id"}, UserSession.scope)
      end
    ...
    def test_initialize
      UserSession.with_scope(:find_options => {awesome: 1}, :id => "some_id") do
        ...
        assert_equal({:find_options => {awesome: 1}, :id => "some_id"}, session.scope)
    ...
    def test_search_for_record_with_scopes
      ...
      session.scope = {:find_options => {company_id: binary_logic.id}}
